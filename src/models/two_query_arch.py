...
from utils import get_image_size, convert_image_np
...
class TWO_QUERY_ARCH(nn.Module):
    def __init__(self, conf, args):
        ...
        self.first_query_budget_frac = torch.tensor(np.sqrt(conf.arch.first_query_budget_frac), device=conf.trainer.device)
